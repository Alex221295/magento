    ...
    \Magento\Framework\Setup\Patch\PatchVersionInterface
{
    ...
    public function apply(): void
    {
        ...
        $filePath = $this->componentRegistrar->getPath(ComponentRegistrar::MODULE, 'AlexYe_CustomerPreferences')
            . DIRECTORY_SEPARATOR . 'etc' . DIRECTORY_SEPARATOR . 'data.csv';

        $tableName = $this->moduleDataSetup->getTable('alex_ye_customer_preferences');
