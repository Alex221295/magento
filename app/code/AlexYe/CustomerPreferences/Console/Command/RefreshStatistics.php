...
namespace AlexYe\CustomerPreferences\Console\Command;
...
class RefreshStatistics extends \Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setName('alexye:customer-preferences:refresh-statistics')
            ->setDescription('Alex Ye Refresh Statistics')
            ->setHelp(<<<'EOF'
